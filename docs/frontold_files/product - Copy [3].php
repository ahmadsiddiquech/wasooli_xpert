...
<div class="container product_page">  
	<div class="left_panel col-lg-3">
     ...
     <div class="col-lg-10  search_heading"> Search Filters <a class="close_icon" href="#">x</a> </div>
     
     <div class="col-lg-10 search_result"> <label>Islamabad</label> <a class="close_icon" href="#">x</a></div>
     </div>
    <div class="col-lg-12 white" id="locals_wrapper">
      <?php  foreach($product_filters->result() as $res_product_filters){ ?>
        <h5><B><?=$res_product_filters->name?>_<?=$res_product_filters->id?> </B>(<?=$res_product_filters->itemcount?>)</h5>
        ...
        <div class="county checkbox">
                <input class="c styled" type="checkbox" name="business_county" value="<?=$res_arr_feature_detail_level_1->id?>"><label><?=$res_arr_feature_detail_level_1->feature_detail?>_<?=$res_arr_feature_detail_level_1->id?>(<?=$res_arr_feature_detail_level_1->itemcount?>)</label>
                <div class="municipalities" data-county="<?=$res_arr_feature_detail_level_1->id?>"  style="margin-left:-10px;">
                    <?php  foreach($arr_feature_level_2[$res_arr_feature_detail_level_1->id]->result() as $res_arr_feature_level_2){ ?>
                    <div class="checkbox">
                        <input class="c styled chk_area" type="checkbox" name="business_county" data-county="Oslo" value="<?=$res_arr_feature_level_2->id?>"><label style="font-family:Verdana, Geneva, sans-serif;color:#FF9900"><B><?=$res_arr_feature_level_2->name?>_<?=$res_arr_feature_level_2->id?></B></label>
                        <div class="municipalities" data-county="<?=$res_arr_feature_level_2->id?>" style="margin-left:-10px;">
                          <?php  foreach($arr_feature_detail_level_2[$res_arr_feature_level_2->id]->result() as $res_arr_feature_detail_level_2){ ?>
                            <div class="checkbox">
                                <input class="c styled chk_area" type="checkbox" name="business_county" value="<?=$res_arr_feature_detail_level_2->id?>"><label><?=$res_arr_feature_detail_level_2->feature_detail?>_<?=$res_arr_feature_detail_level_2->id?>(<?=$res_arr_feature_detail_level_2->itemcount?>)</label>
                                <!--<div class="municipalities" data-county="<?=$res_arr_feature_detail_level_2->id?>" style="margin-left:-10px;">
                                    <div class="checkbox">
                                        <input class="styled chk_area" type="checkbox" name="business_municipality[]"><label>OSLO 3</label>
                                    </div>
           ...
           <!-- <div class="county checkbox">
                <input class="c styled" type="checkbox" name="business_county" value="Vestfold"><label>Vestfold</label>
                <div class="municipalities " data-county="Vestfold"></div>
            </div>-->
         ...
         <?php  foreach($product_filters->result() as $res_product_filters){ ?>
          <li class="list_item">
             ...
             <ul id="multilevel_<?=$res_product_filters->id?>" class="nav sidebar-subnav collapse">
                <li class="sidebar-subnav-header"><?=$res_product_filters->name?></li>
                <?php  foreach($arr_feature_detail_level_1[$res_product_filters->id]->result() as $res_arr_feature_detail_level_1){ ?>
                <li>
                   <a href="#level1_<?=$res_arr_feature_detail_level_1->id?>" title="Level 1" data-toggle="collapse">
...
$(document).off("click", ".chk_area2").on("click", ".chk_area2", function(){
	...
	//	alert('1');
		...
		$("#BilType_"+car_type).prop('checked', true);
	});
*/
